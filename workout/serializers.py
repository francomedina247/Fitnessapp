...
class WorkoutSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model  = Workout
        fields = ('id', 'name', 'description', 'duration', 'calories_burned', 'difficulty', 'category', 'video_url', 'rounds', 'round_duration_seconds', 'round_video_uris', 'instructions', 'created_by', 'created_at')
